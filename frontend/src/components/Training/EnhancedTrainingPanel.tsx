...
import {
  ...
  LinearProgress, Stack, Autocomplete, Accordion, AccordionSummary, AccordionDetails,
...
import {
  ...
  Psychology as PredictiveAnalyticsIcon
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
      ...
      >
        ...
        <DialogContent>
          {evalMetrics ? (
            <InteractiveCharts metrics={evalMetrics} />
          ) : (
